...
HomeBloc _makeBlocWithData() => HomeBloc(
      HomeRepository(mockCloudServiceWithHomeImageData()),
      logger: const NoOpAppLogger(),
      backoff: RetryBackoff(),
    );

HomeBloc _makeBlocFailing() => HomeBloc(
      HomeRepository(mockCloudServiceFailing()),
      logger: const NoOpAppLogger(),
      backoff: RetryBackoff(),
    );
